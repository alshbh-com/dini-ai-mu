...
const Subscription = () => {
  ...
  const features = {
    free: [
      ...
      "حفظ 50 سؤال في المفضلة",
      "مشاركة الإجابات",
      "البحث في الأسئلة المحفوظة",
    ...
    premium: [
      ...
      "إشعارات تذكير الصلاة المخصصة",
      "تحميل الإجابات بصيغة PDF",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 px-4 py-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <Card className="mb-8 bg-green-50 border-2 border-green-200">
          <CardContent className="p-6 text-center">
            ...
            <div className="text-right space-y-3 text-green-700">
              ...
              <p className="text-sm leading-relaxed">
                🔢 <strong>معرف المستخدم:</strong> يظهر في الرسائل لضمان استمرارية الاشتراك عند تغيير الشبكة
              </p>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <Card className="relative shadow-lg border-2 border-gray-200 bg-white/80 backdrop-blur-sm">
            <CardHeader className="text-center pb-4">
              ...
              <p className="text-slate-600 text-sm">للاستخدام الأساسي والمتقدم</p>
            </CardHeader>
            <CardContent>
        ...
        {/* User ID Display */}
        <div className="mt-8">
          <Card className="bg-blue-50 border-blue-200 bg-white/60 backdrop-blur-sm">
            <CardContent className="p-6 text-center">
              <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-4 bg-blue-600 rounded-full flex items-center justify-center">
              ...
              <div className="bg-white p-4 rounded-lg border border-blue-200 mb-4">
                <p className="text-lg font-mono text-blue-700 select-all">
                  {localStorage.getItem('userID') || 'جاري التحميل...'}
                </p>
              </div>
              <p className="text-sm text-blue-700">
                📋 اذكر هذا المعرف عند التواصل معنا عبر واتساب لتفعيل الاشتراك
              </p>
            </CardContent>
          </Card>
        </div>
